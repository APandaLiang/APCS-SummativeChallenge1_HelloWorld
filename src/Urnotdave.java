...
public class Urnotdave {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		String response1 = in.nextLine();
			...
			TimeUnit.SECONDS.sleep(1);
			System.out.println("Humanity has sent humans on a mission with an on-board super intelligent computing system named Hal. This particular human is attempting to commit an act of treason.");
			TimeUnit.SECONDS.sleep(1);
		...
		String response2 = in.nextLine();
			if (response2.equals("yes")){
				...
				TimeUnit.SECONDS.sleep(1);
				System.out.println("I've sealed the doors. Let us begin.");
			}
			else {
				System.out.println("POD BAY DOORS CLOSING.");
				System.out.println("DOORS LOCKED.");
